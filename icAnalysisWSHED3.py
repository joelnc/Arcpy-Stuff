...
ParcelsShp = r'C:\Users\95218\Documents\ArcGIS\sde\ParcUniqLU.shp'
#wsheds = r'C:\Users\95218\Documents\ArcGIS\sde\Watershed_Basins6.shp'
wsheds = r'C:\Users\95218\Documents\ArcGIS\sde\Watershed_Basins_final.shp'
...
with arcpy.da.SearchCursor(wsheds, ["SHAPE@", "TILE_NAME"]) as cursor0:
    ...
    for row0 in cursor0:
        ...
        with arcpy.da.SearchCursor(tempWParc,
                                   ["FID", "SHAPE@", "SHAPE_STAr", "taxpid", "ExistingLU"]) as cursor:
            for row in cursor:
                ## Add to the fid list
                fid.append(row[0])
        ...
        listOfLists = [fid, parArea, totalIc, buildIc, pid, lu]
