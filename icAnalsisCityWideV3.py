...
## Get Building IC
buildingIC = r'C:\Users\95218\Documents\ArcGIS\SCM Crediting\Bfp.shp'
arcpy.MakeFeatureLayer_management(buildingIC, "CitybuildingsIC")

## Make a new feature layer out of buyout buildings
# arcpy.AddField_management("CitybuildingsIC", "areaSF", "FLOAT", 16, 1, "",
#                           "temp", "NULLABLE", "REQUIRED")
# arcpy.CalculateField_management("CitybuildingsIC", "areaSF",
#                                 "!shape.area@squarefeet!", "PYTHON_9.3", "")
...
# arcpy.MakeFeatureLayer_management(ParcelsShp, "CityParcels")
# arcpy.AddField_management("CityParcels", "areaSF", "FLOAT", 16, 1, "",
#                           "temp", "NULLABLE", "REQUIRED")
# arcpy.CalculateField_management("CityParcels", "areaSF",
#                                 "!shape.area@squarefeet!", "PYTHON_9.3", "")
